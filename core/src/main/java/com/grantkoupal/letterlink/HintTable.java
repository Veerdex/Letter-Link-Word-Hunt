...
public class HintTable extends Agent {
    ...
    public HintTable(List<String> validWords, List<Boolean> wordsFound, TextureSet bts){
        ...
        tileTexture = bts.tileTexture;
        boardTexture = bts.boardTexture;
        backgroundTexture = bts.backgroundTexture;
