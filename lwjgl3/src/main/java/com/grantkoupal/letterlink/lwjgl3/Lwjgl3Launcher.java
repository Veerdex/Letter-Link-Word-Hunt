...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("Letter Link");

        configuration.setBackBufferConfig(8, 8, 8, 8, 16, 0, 8); // The last parameter (4) enables 4x MSAA
        ...
        configuration.setWindowedMode(572, 1180);
